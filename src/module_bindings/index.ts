...
import RepairOrdersRow from "./repair_orders_table";

/** Type-only namespace exports for generated type groups. */

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema({
  repairOrders: __table({
    name: 'repair_orders',
    indexes: [
      { accessor: 'number', name: 'repair_orders_number_idx_btree', algorithm: 'btree', columns: [
        'number',
      ] },
    ],
    constraints: [
      { name: 'repair_orders_number_key', constraint: 'unique', columns: ['number'] },
    ],
  }, RepairOrdersRow),
});
...
const reducersSchema = __reducers(
  __reducerSchema("add_or_update_repair_order", AddOrUpdateRepairOrderReducer),
  __reducerSchema("add_transfer_orders", AddTransferOrdersReducer),
  __reducerSchema("delete_repair_order", DeleteRepairOrderReducer),
  __reducerSchema("remove_transfer_order", RemoveTransferOrderReducer),
  __reducerSchema("set_all_parts_are_here_status", SetAllPartsAreHereStatusReducer),
  __reducerSchema("update_notes", UpdateNotesReducer),
  __reducerSchema("update_tech", UpdateTechReducer),
);
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `repairOrders` instead. This alias will be removed in the next major version. */
    readonly "repair_orders": Omit<typeof tablesSchema.schemaType.tables["repairOrders"], "accessorName"> & { readonly accessorName: "repair_orders" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `repairOrders` instead. This alias will be removed in the next major version. */
  readonly "repair_orders": __DbViewBase["repairOrders"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `repairOrders` instead. This alias will be removed in the next major version. */
  readonly "repair_orders": __TablesBase["repairOrders"];
};
